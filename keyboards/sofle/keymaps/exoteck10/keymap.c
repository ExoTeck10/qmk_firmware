 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | WIN  | LAlt |LOWER | Enter| /Space  /       \Enter \  |SPACE |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `---------------------------''------'           '------''---------------------------'
 */
[_COLEMAKDH] = LAYOUT(
  ...
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
    KC_LCTRL,  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,  KC_MUTE,      KC_D_MUTE,  KC_K,    KC_H,   KC_COMM, KC_DOT, KC_SLSH,  KC_LSFT,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
                    KC_LGUI,  KC_LALT, KC_LOWER,  KC_ENT,  KC_SPC,        KC_ENT,  KC_SPC, KC_RAISE, KC_RCTRL, KC_RALT
  //               \--------+---------+--------+---------+---------|    |--------+---------+--------+--------+-------/
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans|      |      |      | WhlUp| PgUp |-------.    ,-------| LEFT | DOWN |  UP  |RIGHT |      |  DEL |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * | trans|      |      |      | WhlDn| PgDn |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_LOWER] = LAYOUT(
  ...
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
     _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U, KC_PGUP,                         XXXXXXX, KC_LEFT,  KC_UP,  KC_RGHT, XXXXXXX, XXXXXXX,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
     _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_D, KC_PGDN, _______,      _______,  XXXXXXX, KC_HOME, KC_DOWN, KC_END,  XXXXXXX, _______,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
 ...
 * | trans|      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans| Ins  | Pscr | Menu |      |      |                    |   ^  |   &  |   *  |   (  |   )  | Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans| LAt  | LCtl |LShift|      | Caps |-------.    ,-------|   -  |   =  |   {  |   }  |   |  |   `  |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * | trans| Undo |  Cut | Copy | Paste|      |-------|    |-------|   _  |   +  |   [  |   ]  |   \  |   ~  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
...
[_RAISE] = LAYOUT(
  ...
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
     _______,  KC_INS, KC_PSCR,  KC_APP, XXXXXXX, XXXXXXX,                         KC_CIRC, KC_PAST, KC_LPRN, KC_RPRN, KC_AMPR, KC_BSPC,
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
...
[_NUMPAD] = LAYOUT(
  //,----------------------------------------------------.                       ,-----------------------------------------------------.
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         XXXXXXX, KC_NLCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         KC_CIRC,  KC_P7,   KC_P8,   KC_P9,  KC_PAST, XXXXXXX,
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         KC_PMNS,  KC_P4,   KC_P5,   KC_P6,  KC_EQL,  _______,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,      _______,  KC_PPLS,  KC_P1,   KC_P2,   KC_P3,  KC_SLSH, _______,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |coledh| qwer | low  | raise|  adj |numpad|                    |switch|      |      |      |      |RESET |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |bright up|   |-------.    ,-------|      |      |      |      |      |EEP_RST|
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * | SLEEP|      |      |      |bright dn|   |-------|    |-------|      |      |      |      |      |      |
...
[_SWITCH] = LAYOUT(
  ...
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
      TO(0),   TO(1),   TO(2),   TO(3),   TO(4),  TO(5),                            TO(6),  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  RESET,
  //|-------+--------+--------+--------+--------+--------|                       |--------+--------+--------+--------+--------+--------|
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, EEP_RST,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
      KC_PWR, KC_SLEP, KC_WAKE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|-------+--------+--------+--------+--------+--------|  ====  |     |  ====  |--------+--------+--------+--------+--------+--------|
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TAB  |   Q  |   W  |   F  |   P  |   G  |                    |   J  |   L  |   U  |   Y  |   ;  | trans|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |LShift|   A  |   R  |   S  |   T  |   D  |-------.    ,-------|   H  |   N  |   E  |   I  |   O  | trans|
 * |------+------+------+------+------+------|  MUTE |    |DISCORD|------+------+------+------+------+------|
 * | LCTR |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   K  |   M  |   ,  |   .  |   /  | trans|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | Bspc | WIN  |LOWER | Enter| /Space  /       \Enter \  |SPACE |RAISE | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
